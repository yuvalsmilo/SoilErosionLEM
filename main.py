...
ax.plot(elapsed_dt_vec_minutes, Q_at_node, color='blue', linewidth=3)
ax2  = ax.twinx()
ax2.plot(elapsed_dt_vec_minutes, sediment_weight_flux_kg_s,color='green', linewidth=3)
ax.set_ylim([0,0.15])
...
plt.savefig('rainfall.jpg', dpi=300)
plt.show()
